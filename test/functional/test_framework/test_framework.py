...
TMPDIR_PREFIX = "bitcoinsilver_func_test_"
...
class BitcoinTestFramework(metaclass=BitcoinTestMetaClass):
    ...
    def parse_args(self, test_file):
        ...
        parser.add_argument("--nocleanup", dest="nocleanup", default=False, action="store_true",
                            help="Leave bitcoinsilverds and test.* datadir on exit or error")
        ...
        parser.add_argument("--usecli", dest="usecli", default=False, action="store_true",
                            help="use bitcoinsilver-cli instead of RPC for all commands")
    ...
    def get_binary_paths(self):
        ...
        binaries = {
            "bitcoinsilverd": ("bitcoind", "BITCOIND"),
            "bitcoinsilver-cli": ("bitcoincli", "BITCOINCLI"),
            "bitcoinsilver-util": ("bitcoinutil", "BITCOINUTIL"),
            "bitcoinsilver-chainstate": ("bitcoinchainstate", "BITCOINCHAINSTATE"),
            "bitcoinsilver-wallet": ("bitcoinwallet", "BITCOINWALLET"),
        }
