...
class PSBTTest(BitcoinTestFramework):
    def set_test_params(self):
        ...
        # segwit activation in Bitcoinsilver), explicitly specify the address
        # type for this test.
        self.extra_args = [
    ...
    def run_test(self):
        ...
        self.log.info("Test walletcreatefundedpsbt fee rate of 10000 sat/vB and 0.1 BTCS/kvB produces a total fee at or slightly below -maxtxfee (~0.05290000)")
        ...
        assert_raises_rpc_error(-8, "Cannot specify both fee_rate (sat/vB) and feeRate (BTCS/kvB)",
