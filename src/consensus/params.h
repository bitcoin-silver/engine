...
public:
    ...
    virtual CAmount MinBitcoinSilverAmount(unsigned nHeight) const = 0;
...
public:
    ...
    CAmount MinBitcoinSilverAmount(unsigned nHeight) const override
    {
        if (nHeight < 212500)
            return 0;
...
public:
    ...
    CAmount MinBitcoinSilverAmount(unsigned) const override
    {
        return COIN / 100;
    }
