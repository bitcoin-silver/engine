...
BOOST_AUTO_TEST_CASE (name_tx_verification)
{
  ...
  /* ****************************************************** */
  /* Try out the Bitcoinsilver / non-Bitcoinsilver tx version check.  */
