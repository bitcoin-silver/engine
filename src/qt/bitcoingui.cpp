...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Bitcoinsilver address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments and name transfers (generates QR codes and bitcoinsilver: URIs)"));
    ...
    openAction->setStatusTip(tr("Open a bitcoinsilver: URI"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Bitcoinsilver command-line options").arg(CLIENT_NAME));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        ...
        tooltip = tr("%n active connection(s) to Bitcoinsilver network.", "", count);
    } else {
        //: A substring of the tooltip.
