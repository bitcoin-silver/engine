...
{
    switch (unit) {
    case Unit::BTC: return QString("Bitcoinsilvers");
    case Unit::mBTC: return QString("Milli-Bitcoinsilvers (1 / 1" THIN_SP_UTF8 "000)");
    case Unit::uBTC: return QString("Micro-Bitcoinsilvers (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
