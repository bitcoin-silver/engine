...
/**
 * Build genesis block for testnet.  In Bitcoinsilver, it has a changed timestamp
...
public:
    CMainParams() {
        ...
        /* Bitcoinsilver activates CSV/Segwit with BIP16.  */
        ...
        // The value is the chain work of the Bitcoinsilver mainnet chain at height
        ...
        assert(consensus.hashGenesisBlock == uint256{"00000ea8e97e04892a03df35947ff0c4df705723f5b18be7cc6456ed16e9788e"});
        assert(genesis.hashMerkleRoot == uint256{"f7224a6085bc48821bd7c7c1fa0f0e4aa1f7217da863af69f8c1c102e1184b39"});
        ...
        /* See also doc/BitcoinsilverBugs.txt for more explanation on the
           historical bugs added below.  */

        /* These transactions have name outputs but a non-Bitcoinsilver tx version.
           They contain NAME_NEWs, which are fine, and also NAME_FIRSTUPDATE.
           The latter are not interpreted by bitcoinsilverd, thus also ignore
           them for us here.  */
        ...
        /* These are non-Bitcoinsilver tx that contain just NAME_NEWs.  Those were
           ...
           "ignore" them, as their outputs need no special Bitcoinsilver handling
...
public:
    CTestNetParams() {
        ...
        // The best chain should have at least this much work.
        // The value is the chain work of the Bitcoinsilver testnet chain at height
        ...
        vSeeds.emplace_back("dnsseed.test.bitcoinsilver.webbtc.com."); // Marius Hanne
        ...
        // FIXME: Bitcoinsilver has no fixed seeds for testnet, so that the line
    ...
    explicit SigNetParams(const SigNetOptions& options)
    {
        ...
        if (!options.challenge) {
            /* FIXME: Adjust the default signet challenge to something else if
               we want to use signet for Bitcoinsilver.  */
