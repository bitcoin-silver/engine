...
public:
    ...
    {
        LOCK(m_wallet->cs_wallet);
        auto res = CreateTransaction(*m_wallet, recipients, nullptr, change_pos == -1 ? std::nullopt : std::make_optional(change_pos),
                                     coin_control, sign);
...
public:
    ...
    void registerRpcs() override
    {
        ...
        /* Many of the non-wallet Bitcoinsilver RPCs can use a wallet optionally,
