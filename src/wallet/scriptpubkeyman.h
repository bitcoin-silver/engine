...
public:
     ...
     *  keys.  This is something we need for Bitcoinsilver's deterministic salts
...
public:
    ...
    std::unique_ptr<SigningProvider> GetSigningProviderWithKeys(const CScript& script) const override;
