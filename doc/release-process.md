...
* ( **Not in Bitcoinsilver yet.** ) Update [bips.md](bips.md) to account for changes since the last release.
...
( **These are handled by upstream Bitcoin Core, not Bitcoinsilver.** )
...
- ( **Not in Bitcoinsilver yet.** ) Translations on Transifex
...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/bitcoinsilver/guix.sigs.git
    #git clone https://github.com/bitcoinsilver/bitcoinsilver-detached-sigs.git # Bitcoinsilver doesn't use detached sigs yet, so don't do this.
    git clone https://github.com/bitcoinsilver/bitcoinsilver-core.git

### Write the release notes

( **Not in Bitcoinsilver yet.** )
...
Checkout the Bitcoinsilver Core version you'd like to build:

```sh
pushd ./bitcoinsilver-core
...
- Detached signatures will then be committed to the [bitcoinsilver-detached-sigs](https://github.com/bitcoinsilver-core/bitcoinsilver-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Upload to the bitcoinsilver.org server (`/var/www/bin/bitcoinsilver-core-${VERSION}/`):
    1. The contents of each `./bitcoinsilver-core/guix-build-${VERSION}/output/${HOST}/` directory.
...
( **The following is not in Bitcoinsilver yet.** )
...
- Optionally help seed this torrent. To get the `magnet:` URI use:
  ...
  people without access to `bitcoinsilver.org` to download the binary distribution.
...
- Update repositories
  ...
  - Create a [new GitHub release](https://github.com/bitcoinsilver/bitcoinsilver-core/releases/new) with a link to the archived release notes
...
- Announce the release:
  ...
  - Bitcoinsilver Twitter https://twitter.com/bitcoinsilver
