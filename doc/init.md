...
group. Access to bitcoinsilver-cli and other namecoind rpc clients can then be
...
Copy org.bitcoinsilver.namecoind.plist into ~/Library/LaunchAgents. Load the launch agent by
running `launchctl load ~/Library/LaunchAgents/org.bitcoinsilver.namecoind.plist`.
...
You will need to modify org.bitcoinsilver.namecoind.plist if you intend to use it as a
