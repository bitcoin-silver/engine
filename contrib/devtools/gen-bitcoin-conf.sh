...
BITCOIND=${BITCOIND:-$BINDIR/bitcoinsilverd}
SHARE_EXAMPLES_DIR=${SHARE_EXAMPLES_DIR:-$TOPDIR/share/examples}
EXAMPLE_CONF_FILE=${EXAMPLE_CONF_FILE:-$SHARE_EXAMPLES_DIR/bitcoinsilver.conf}
...
then
  ...
  echo -e "To safely generate a bitcoinsilver.conf file, please commit your changes to $BITCOIND, rebuild, then run this script again.\n"
fi

echo 'Generating example bitcoinsilver.conf file in share/examples/'
